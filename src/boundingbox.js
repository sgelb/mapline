...
class BoundingBox {
  ...
  resize(newWidth, newHeight) {
    ...
    let w = this._ruler.destination(
      [this.bounds.getWest(), this.bounds.getNorth()], wDiff, 270)[0];
    let s = this._ruler.destination(
      [this.bounds.getWest(), this.bounds.getSouth()], hDiff, 180)[1];
    let e = this._ruler.destination(
      [this.bounds.getEast(), this.bounds.getNorth()], wDiff, 90)[0];
    let n = this._ruler.destination(
      [this.bounds.getWest(), this.bounds.getNorth()], hDiff, 0)[1];
